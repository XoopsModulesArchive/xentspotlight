<?php
/**
 * $Id: upload.php,v 1.4 2005/04/07 15:10:27 m4d3l Exp $
 * Module: WF-Channel
 * Version: v1.0.5
...
switch ($op) {
    case 'upload':
        ...
        if ('' != $HTTP_POST_FILES['uploadfile']['name']) {
            ...
            spot_uploading($allowed_mimetypes, $HTTP_POST_FILES['uploadfile']['name'], 'upload.php', 0, $_POST['uploadpath'], 1);
        } else {
    ...
    case 'delfile':
        ...
        if (isset($confirm) && 1 == $confirm) {
            ...
            xoops_cp_header();
            xoops_confirm(['op' => 'delfile', 'uploadpath' => $_POST['uploadpath'], 'channelfile' => $_POST['channelfile'], 'confirm' => 1], 'upload.php', _AM_DELETEFILE . '<br><br>' . $_POST['channelfile'], 'Delete');
    ...
    default:
        ...
        $namearray = [0 => 'Choose Upload Type', 1 => _AM_NEWSIMAGES , 2 => _AM_WFSECTIONIMAGES];
        $listarray = [0 => '', 1 => _AM_UPLOADCHANLOGO , 2 => _AM_UPLOADLINKIMAGE];
        $displayimage = '';
